...
function toSetValue(value,row,index){
	var code = null;
	if(value=="NO_ACTIVATE" ){
		code = '<span class="label label-primary">未激活</span>';
	}else if(value=="NO_REMAIN" ){
		code = '<span class="label label-info">未留存</span>';
	} else {
		code = value;
	}
	return code;
...
<div class="panel-body panel-body-noheader panel-body-noborder" style="width: auto; height: auto;">
	<form action="${pageContext.request.contextPath}/newCustomer/findNewCustomer.action" class="coeus-form form-inline col3" method="post" role="form" id="queryForm">
		<div class="panel panel-primary coeus-primary">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<select class="form-control" name="resultType" >
                			<option value=""></option>
			                <option value="NO_ACTIVATE">未激活</option>
			                <option value="NO_REMAIN">未留存</option>
            			</select>
					</div> 
					<div class="input-group">
			...
			<div class="text-center">
	            ...
	            <button type="button" class="btn btn-info btn-blue" onclick="exportForm('${pageContext.request.contextPath}/newCustomer/exportNewCustomer.action')">
