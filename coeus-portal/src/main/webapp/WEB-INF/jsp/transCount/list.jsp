...
<div class="panel-body panel-body-noheader panel-body-noborder" style="width: auto; height: auto;">
	<form action="${pageContext.request.contextPath}/transCount/findAllList.action" class="coeus-form form-inline col3" method="post" role="form" id="queryForm">
...
<div class="panel-body panel-body-noheader panel-body-noborder" style="width: auto; height: auto;">
	<table id="table" class="table table-responsive coeus-table" >
		<thead>
			<tr>
				<th data-field="ORDER_TIME" data-align="center" data-formatter="formatDate">交易日期</th>
           		<th data-field="CUST_NUM" data-align="center">交易商户数</th>
           		<th data-field="TRANS_AMOUNT" data-align="center">交易金额</th>
           		<th data-field="TRANS_NUM" data-align="center">交易订单数</th>
			</tr>
		</thead>
	</table>
</div>
