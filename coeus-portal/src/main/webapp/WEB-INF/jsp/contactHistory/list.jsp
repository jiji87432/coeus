...
function toUpload(){
	location.href ='${pageContext.request.contextPath}/contactHistory/toUpload';
}

function toDoValue(value,row,index){
	return '<a class="btn active" href="${pageContext.request.contextPath}/contactHistory/queryDetail.action?id='+value+'">编辑</a>';
}
...
function toAdd(){
	location.href ='${pageContext.request.contextPath}/contactHistory/queryDetail.action';
}
</script>
</head>
<body>
<div class="panel-body panel-body-noheader panel-body-noborder" style="width: auto; height: auto;">
	<form action="${pageContext.request.contextPath}/contactHistory/findAllList.action" class="coeus-form form-inline col3" method="post" role="form" id="queryForm">
		<div class="panel panel-primary coeus-primary">
			...
			<div class="text-center">
	            ...
	            <!-- <button type="button" class="btn btn-primary btn-blue" id="findlist" onclick="toUpload()">导入</button> -->
	        </div>
	        <br>
		</div>
	</form>
