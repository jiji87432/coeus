package com.pay.coeus.core.plugin;
...
import com.pay.commons.web.mybatis.ReflectHelper;

/**
 * <p>Title:PagePlugin</p>
 * <p>Description:MyBatis 高版本分页</p>
 * @author yongda.ren
 * @date 2017年10月23日 下午5:16:51
 */
...
public class PagePlugin implements Interceptor {
	...
	public Object intercept(Invocation ivk) throws Throwable {
		...
		if (ivk.getTarget() instanceof RoutingStatementHandler) {
			...
			if(mappedStatement.getId().indexOf(".boss.")>-1){
				dialect = "oracle";
			}
