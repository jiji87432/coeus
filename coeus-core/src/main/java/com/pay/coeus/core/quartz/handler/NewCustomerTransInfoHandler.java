 ...
 */
@JobHander(value = "newCustomerTransInfoHandler")
@Component
public class NewCustomerTransInfoHandler extends BaseJobHandler {
	
	private Logger logger = LoggerFactory.getLogger(NewCustomerTransInfoHandler.class);
	...
	public ReturnT<String> execute(String... params) throws Exception {
		int customerActivateTrans = newCustomerActivateService.loadNewCustomerActivateTrans(30);
